...
C  nbStrips      :: number of strips (if region to update is splitted)
      ...
      Real*8  vLoc, alf1, alf1q, alpmn
      Real*8  alfp, alpq, alp1, locTp
      Real*8  alfn, alnq, aln1, locTn
      Real*8  alp  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  aln  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_v (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_v (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_o (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_o (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_x (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_x (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_y (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_y (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_z (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_z (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_xx(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_xx(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_yy(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_yy(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_zz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_zz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_xy(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_xy(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_xz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_xz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fp_yz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  fn_yz(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
CEOP

      recip_dT = 0.
      IF ( deltaTloc.GT.zeroRL ) recip_dT = 1.0D0 / deltaTloc
...
C      add into grid box (j): positive V(j) and negative V(j+1)
     ...
     &   - 5.D0*(-alpmn*alf1*sm_y(i,j) + alfp*alp1*fp_y(i,j)
