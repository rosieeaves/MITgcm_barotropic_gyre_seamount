...
C  msgBuf        :: Informational/error message buffer
      ...
      Real*8 afr     (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  smVol  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8  smTr0  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
...
C--   Set advective fluxes at the very bottom:
         DO j=1-OLy,sNy+OLy
          DO i=1-OLx,sNx+OLx
           ...
           fp_z (i,j,kDown) = 0.D0
           fn_z (i,j,kDown) = 0.D0
           fp_xx(i,j,kDown) = 0.D0
           fn_xx(i,j,kDown) = 0.D0
           fp_yy(i,j,kDown) = 0.D0
           fn_yy(i,j,kDown) = 0.D0
           fp_zz(i,j,kDown) = 0.D0
           fn_zz(i,j,kDown) = 0.D0
           fp_xy(i,j,kDown) = 0.D0
           fn_xy(i,j,kDown) = 0.D0
           fp_xz(i,j,kDown) = 0.D0
           fn_xz(i,j,kDown) = 0.D0
           fp_yz(i,j,kDown) = 0.D0
           fn_yz(i,j,kDown) = 0.D0
          ENDDO
         ENDDO
        ENDIF
